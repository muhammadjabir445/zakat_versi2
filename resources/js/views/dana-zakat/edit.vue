    ...
    created() {
        let url = window.location.pathname
         ...
         .then((ress) => {
                ...
                this.nama_yayasan = ress.data.data.id_penyalur
                this.uang = ress.data.data.total_uang
                this.beras = ress.data.data.total_beras
                this.deskripsi = ress.data.data.deskripsi
                if (ress.data.data.id_penyalur) {
                    this.jenis_pengajuan = 'Pembagian zakat'
                } else {
                    this.jenis_pengajuan = 'Pembelian zakat'
